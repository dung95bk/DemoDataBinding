...
@BindingMethods({
        ...
        @BindingMethod(type = TextViewCustom.class, attribute = "android:inputType", method = "setRawInputType"),
        @BindingMethod(type = TextViewCustom.class, attribute = "android:maxLength", method = "setMaxLines2"),
...
public class BindingMethodDemo {
    ...
    public static void setTextWatcher(TextView view, final androidx.databinding.adapters.TextViewBindingAdapter.BeforeTextChanged before,
                                      final androidx.databinding.adapters.TextViewBindingAdapter.OnTextChanged on, final androidx.databinding.adapters.TextViewBindingAdapter.AfterTextChanged after,
